	                ...
	                <div class="container-fluid">
	                    ...
	                    <div class="card shadow mb-4">
	                        ...
	                        <div class="card-body">
	                            <div class="row">
		                            <div class="col-6">
		                                <div id="notifications"><?php echo $this->session->flashdata('addPegawai'); ?></div>
		                                <form action="<?php echo site_url(''); ?>/c_pemilik/addPegawai/" method="POST" enctype="multipart/form-data">
		                                    <div class="mb-3">
